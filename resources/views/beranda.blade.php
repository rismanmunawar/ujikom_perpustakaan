...
<head>
    ...
    <title>Perpustakaan | Ujikom</title>
    ...
    <style>
        .header-top {
            ...
            /* Gunakan lebar penuh */
            top: 0;
            /* Tempatkan di bagian atas */
            z-index: 1000;
            /* Tetapkan z-index tinggi untuk memastikan header muncul di atas konten lain */
        }

        .main-navbar {
            margin-top: 100px;
            /* Berikan margin atas pada konten utama untuk mencegah tumpang tindih dengan header */
        }
    </style>
</head>
                ...
                <div class="header-top">
                    <div class="container">
                        ...
                        <div class="header-top-right">
                            <a href="{{ route('login') }}" class="btn icon icon-left btn-primary">
                ...
                <nav class="main-navbar">
                    <div class="container">
                        <ul>
                            ...
                            <li class="menu-item">
                                <a href="index.html" class='menu-link'>
                                    <span><i class="bi bi-book-fill"></i> Daftar Buku</span>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="index.html" class='menu-link'>
                                    <span><i class="bi bi-info-circle-fill"></i> Tentang Perpustakaan</span>
                                </a>
                            </li>
