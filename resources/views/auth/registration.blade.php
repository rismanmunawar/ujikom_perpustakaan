    ...
    <div id="auth">
        ...
        <div class="row h-100">
                    ...
                    <form action="{{ route('register.post') }}" method="POST">
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="text" id="nm_pengguna" class="form-control form-control-xl"
                                placeholder="Nama Pengguna" name="nm_pengguna" required autofocus>
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="password" id="password" class="form-control form-control-xl" name="password"
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <select class="form-control form-control-xl" id="hak_akses" name="hak_akses"
                                aria-label="hak_akses" placeholder="Confirm Password">
            ...
            <div class="col-lg-7 d-none d-lg-block">
                <div id="auth-right">
                    <img src="perpustakaan.jpg" alt="Deskripsi Gambar">
                </div>
            </div>
